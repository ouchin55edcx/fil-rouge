...
@section('content')
    ...
    <script>
      ...
      <div class="flex items-center mb-2">
        ...
        <button class="inline-flex justify-center rounded-md border border-transparent bg-purple-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2">Add Question</button>
      </div>
      <div class="mb-2">
      ...
      <button class="inline-flex justify-center rounded-md border border-transparent bg-red-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2" onclick="removeTaskForm(this)">Remove Task</button>
    `;
                ...
                const addQuestionButton = taskForm.querySelector('button');
      ...
      <button class="inline-flex justify-center rounded-md border border-transparent bg-red-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2" onclick="removeQuestionForm(this)">Remove Question</button>
    `;
            ...
            function removeTaskForm(button) {
                const taskForm = button.parentNode;
