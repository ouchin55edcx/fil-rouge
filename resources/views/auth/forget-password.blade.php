...
@section('content')
    <section class="bg-[#161E2D] h-36 w-full flex  items-center gap-4 ">
        ...
        <div>
            <h1 class="text-white font-bold text-3xl">Forgot Password</h1>
            <span class="text-gray-400">Enter your email below to receive a special link to reset your password </span>
        </div>
    </section>
    ...
    <footer class="text-gray-600 body-font ">
        <div
            class="container px-5 py-24 mx-auto border-t-4 border-indigo-500  flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
